...
Iteration two consists of the following use cases. We have written them in the /user story/ form 
instead of traditional UML use-case diagram, for better clarity.
 1) Admin can manage the Sample, in order to detect and reduce the possible mistakes they make while data collection.
 2) Admin can manage the Movies, so that the studio will be able evaluate their movie. From a developer's perspective, a wider library of movies can be used to create more datasets and that means a larger dataset can be used to develop and evaluate the system.
 3) Admin can analyse the movie, so that they can get a score. This is use case 2 in our current iteration. We will be working on this use-case on every iteration.

Some of the use-cases we mentioned is currently possible without using our software. For example, /Admin/ can manage the Samples 
...
[fn:3] Future plans are also described further under the conclusion chapter. 
...
#+NAME: table:utest_m2
#+ATTR_LATEX: :environment longtable :align |p{7in}|
#+CAPTION: Unit Test M2
|---------------------------------------------------------------------------------------|
| <85>                                                                                  |
| *Unit Test Plan* \cellcolor{blue!25}                                                  |
|---------------------------------------------------------------------------------------|
|---------------------------------------------------------------------------------------|
| Module Name:\underline{BEGR} \hspace{2in}  file:  "./src/head_pose.py"                |
|---------------------------------------------------------------------------------------|
| *1. Module Overview*                                                                  |
|---------------------------------------------------------------------------------------|
...
#+NAME: fig:exprnet
#+CAPTION: Expression Net 
#+ATTR_LATEX: :width 7in
#+RESULTS:
[[./ext_img/expr_net.png]]
