...
\label{sec:orgb90c608}
\chapter{Introduction}
\label{sec:org087ee79}
...
\hline
\end{tabular}
\end{table}\footnotetext[1]{\label{org5d13a9b}Use case was designed by faith and implemented by Ibrahim.}\footnotetext[2]{\label{org04aec1c}FER portion of use-case was created by Faith and BEGR was created by Ibrahim.}


\chapter{Non-Functional Requirements}
\label{sec:org89c3b43}
\section{Technical Requirements}
\label{sec:org0f2edf9}
\subsection{Prototype 1 - BIT304}
\label{sec:orgfc0a7d5}
...
\hline
\end{tabular}
\end{table}\footnotetext[3]{\label{org9d2cb0e}Future use cases are described under the conclusion chapter.}
...
\label{sec:org155495b}
\subsection{Pipeline diagrams}
\label{sec:org0e0c7dd}
