...
\label{sec:orgb532f70}

\section{Funding Sources}
\label{sec:org31f658c}
...
\label{sec:org972cd73}
\section{Use-Case Diagrams}
\label{sec:org5a95f98}
...
\hline
\end{tabular}
\end{table}\footnotetext[1]{\label{org44c63d8}Use case was designed by faith and implemented by Ibrahim.}\footnotetext[2]{\label{orgb237e9a}FER portion of use-case was created by Faith and BEGR was created by Ibrahim.}


\chapter{Non-Functional Requirements}
\label{sec:org9aa014f}
\section{Technical Requirements}
\label{sec:org2e5b653}
\subsection{Prototype 1 - BIT304}
\label{sec:orgf82f37f}
...
\hline
\end{tabular}
\end{table}\footnotetext[3]{\label{org5460412}Future plans are also described further under the conclusion chapter.}
...
\label{sec:org7fe37ed}
\subsection{Pipeline diagrams}
\label{sec:org3aa70c3}
