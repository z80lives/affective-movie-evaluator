...
\part{Proposal}
\label{sec:orgc52436b}
\chapter{Introduction}
\label{sec:org95598e0}
...
\label{sec:orgb87423a}

\section{Funding Sources}
\label{sec:org4e44a05}
...
\label{sec:orgc0a0025}
\chapter{Introduction}
\label{sec:org814a8e0}
...
\label{sec:org8fd3b47}
\chapter{Introduction}
\label{sec:org6c1b02a}
...
\label{sec:org6cb03ab}
\section{Use-Case Diagrams}
\label{sec:org33ace38}
...
\hline
\end{tabular}
\end{table}\footnotetext[1]{\label{orgc46f951}Use case was designed by faith and implemented by Ibrahim.}\footnotetext[2]{\label{org3300efa}FER portion of use-case was created by Faith and BEGR was created by Ibrahim.}


\chapter{Non-Functional Requirements}
\label{sec:org4553359}
...
\hline
\end{tabular}
\end{table}\footnotetext[3]{\label{orgc0212ce}Future use cases are described under the conclusion chapter.}
